...
import com.github.kotlintelegrambot.Bot import com.github.kotlintelegrambot.bot import com.github.kotlintelegrambot.dispatch import com.github.kotlintelegrambot.dispatcher.* import com.github.kotlintelegrambot.entities.* import com.github.kotlintelegrambot.entities.keyboard.* import com.github.kotlintelegrambot.extensions.filters.Filter import com.github.kotlintelegrambot.logging.LogLevel import kotlinx.coroutines.CoroutineScope import kotlinx.coroutines.Dispatchers import kotlinx.coroutines.launch import org.example.bot.session.SessionManager import org.example.bot.utils.chatId import org.example.data.remote.repository.WeatherRepository
...
private fun Dispatcher.setupCallbacks() {
    callbackQuery("getMyLocation") {
        ...
        val waitingMessageId = sent.getOrNull()?.messageId
    ...
    callbackQuery("enterManually") {
        ...
        val promptMessageId = prompt.getOrNull()?.messageId
        ...
        message(Filter.Text) {
            ...
            val confirmMsgId = confirmation.getOrNull()?.messageId
            if (confirmMsgId != null) {
                session.confirmationMsgId = confirmMsgId
            }
        }
    }
    ...
    callbackQuery("yes_label") {
        ...
        val loadingMessageId = loading.getOrNull()?.messageId
...
private fun Dispatcher.setupCommands() {
    ...
    command("weather") {
        ...
        val commandMessageId = sent.getOrNull()?.messageId
